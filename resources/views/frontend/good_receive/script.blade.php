    ...
    function get_po_data() {
        ...
        $.ajax({
            ...
            success: function(data) {
                console.log(data);
                var HTML = '';
                HTML += '<option value="">Pilih Nomor Purchase Order </option>';
                for (var i = 0; i < data.length; i++) {
                    HTML += '<option value="' + data[i].id + '">' + data[i].purchase_order_number + '</option>';
                }
    ...
    $("#po_id").change(function(){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                vendors += data.po.vendor.city.city_name+', '+data.po.vendor.province.province_name+' '+data.po.vendor.postal_code+'<br>';
                ...
                whs += data.po.gudang.rcity.city_name+', '+data.po.gudang.rprovince.province_name+' '+data.po.gudang.postal_code+'<br>';
                whs += 'Indonesia <br>';
