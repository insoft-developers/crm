        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="btn-reject-data" type="button" class="btn btn-danger btn-sm"><i class="fa fa-close"></i> Tolak</button>
                    <button id="btn-approve-data" type="button" class="btn btn-success btn-sm"><i class="fa fa-check"></i>Setujui</button>
