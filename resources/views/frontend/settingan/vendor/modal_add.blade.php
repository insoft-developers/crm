                            ...
                            <div class="row">
                                ...
                                <div class="col-5">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label class="label-insoft bintang">Tipe Vendor</label>
                                                <select class="form-control" id="vendor_type" name="vendor_type">
                                                    <option value="" selected disabled>Pilih tipe vendor
                                                    </option>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="label-insoft bintang">Vendor Code</label>
                                                <input type="text" class="form-control" id="vendor_code"
                                                    name="vendor_code" placeholder="cth: V-10221">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="vendor_grade" name="vendor_grade">
