    ...
    function detailData(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $(".modal-title").text("Detail Data Vendor");
...
<script>
    ...
    function addData() {
        ...
        $(".modal-title").text("Tambah Data Vendor");
    ...
    $("#form-add").submit(function(e) {
        ...
        e.preventDefault();
        var id = $('#id').val();
        if (save_method == "add") url = "{{ url('/vendors') }}";
        else url = "{{ url('/vendors') . '/' }}" + id;
        $.ajax({
            url: url,
            type: "POST",
    ...
    function editData(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#vendor_name").val(data.customer.vendor_name);
                $("#tanggal_aktif").val(data.customer.tanggal_aktif);
                $("#vendor_type").val(data.customer.vendor_type);
                $("#alamat").val(data.customer.alamat);

                $("#phone").val(data.customer.phone);
                $("#email").val(data.customer.email);
                $("#vendor_code").val(data.customer.vendor_code);
                ...
                $("#vendor_grade").val(data.customer.vendor_grade);
                ...
                if (data.customer.foto == null) {
                    ...
                    var avatarURL = "{{ asset('storage/vendors') }}" + "/" + data.customer.foto;
                }
