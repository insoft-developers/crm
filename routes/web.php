...
Route::group(['middleware' => ['auth', 'verified', 'is_active']], function () {
  ...
  Route::post('purchase_request_propose', [PurchaseRequestController::class, 'propose'])->name('purchase.request.propose');
  ...
  Route::post('purchase_order_propose', [PurchaseOrderController::class, 'propose'])->name('purchase.order.propose');
